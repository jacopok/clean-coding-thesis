...
run_pandoc:
	pandoc -f markdown-implicit_figures --citeproc --pdf-engine=xelatex -V papersize:a4 --listings galileian_thesis.md --toc --template=default.latex -o galileian_thesis_pandoc_only.pdf
